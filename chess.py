...
def testGame():
    ...
    b = [[rb0, " ", " ", " ", kb0, " ", " ", rb1],
         ...
         [" ", " ", " ", " ", " ", " ", " ", " "],
         [" ", " ", " ", " ", " ", " ", " ", " "],
         [pw0, pw1, pw2, qb0, pw4, pw5, pw6, pw7],
         [rw0, " ", " ", " ", kw0, " ", " ", rw1]]
    # rows Y
    for i in range(8):
        # cols X
...
def testCases():
    ...
    b = [[rb0, " ", " ", " ", kb0, " ", " ", rb1],
         [pb0, pb1, qw0, pb3, pb4, " ", qw0, pb7],
         [" ", " ", " ", " ", " ", " ", " ", " "],
         [" ", " ", " ", " ", " ", " ", " ", " "],
         [" ", " ", " ", " ", " ", " ", " ", " "],
         [" ", " ", " ", " ", " ", " ", " ", " "],
         [pw0, qb0, pw2, qb0, pw4, " ", qb0, pw7],
         [rw0, " ", " ", " ", kw0, " ", " ", rw1]]
    setPositions(b)
    if kw0.move(b, rw1.getX(), rw1.getY()):
        print("FAILED TEST CASE 4.1 ATTEMPT A NON VALID CASTLE A ENEMY PIECE CAN MOVE THERE! ")
    if kw0.move(b, rw0.getX(), rw0.getY()):
        print("FAILED TEST CASE 4.2 ATTEMPT A NON VALID CASTLE A ENEMY PIECE CAN MOVE THERE!")
    if kb0.move(b, rb0.getX(), rb0.getY()):
        print("FAILED TEST CASE 4.3 ATTEMPT A NON VALID CASTLE A ENEMY PIECE CAN MOVE THERE!")
    if kb0.move(b, rb1.getX(), rb1.getY()):
        print("FAILED TEST CASE 4.4 ATTEMPT A NON VALID CASTLE A ENEMY PIECE CAN MOVE THERE!")
        ...
        for j in range(8):
            if (temp[i][j] != " "):
                    ...
                    if temp[i][j].getPlayer() != player and temp[i][j].move(temp, x, y) and temp[i][j].getType() != "p":
                        ...
                        return True
def getEnemyPieces(board, player):
    list = queue
    list.Queue.put()
    for i in range(8):
        for j in range(8):
